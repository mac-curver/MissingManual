...
+ (void) initialize
{
	...
	NSUserDefaultsController *myDefaultsController =
	...
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor brownColor]]	   forKey:@"chColor1"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor redColor]]	   forKey:@"chColor2"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor orangeColor]]   forKey:@"chColor3"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor yellowColor]]   forKey:@"chColor4"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor greenColor]]	   forKey:@"chColor5"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor blueColor]]	   forKey:@"chColor6"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor purpleColor]]   forKey:@"chColor7"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor darkGrayColor]] forKey:@"chColor8"];
	...
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor purpleColor]]  forKey:@"gridColor"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor whiteColor]]	  forKey:@"bkgColor"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor greenColor]]	  forKey:@"cursorColor"];
	[myInitialValues setValue:[NSKeyedArchiver archivedDataWithRootObject:[NSColor magentaColor]] forKey:@"specialColor"];
