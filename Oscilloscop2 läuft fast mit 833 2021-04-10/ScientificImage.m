...
- (void)mouseDown:(NSEvent *)theEvent
{
	...
	while (keepOn) {
        theEvent = [[self window] nextEventMatchingMask: NSEventMaskLeftMouseUp | NSEventMaskRightMouseUp | NSEventMaskLeftMouseDragged];
...
- (void)	plotData:(float*)buffer startIndex:(unsigned long)index length:(unsigned long)length
